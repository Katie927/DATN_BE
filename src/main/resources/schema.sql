...
--
-- Bảng phụ thuộc cấp 1 (Con của các bảng trên)
--
...
CREATE TABLE `notification` (
  `id` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `recipient_user_id` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `FK_notification_recipient_user` (`recipient_user_id`),
  CONSTRAINT `FK_notification_recipient_user` FOREIGN KEY (`recipient_user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Bảng phụ thuộc cấp 4 (Bảng gây lỗi ban đầu)
--
